...
class EED_Payment_Methods_Pro_Event_Payment_Method_Test extends EE_UnitTestCase {
    ...
    function test_show_payment_methods_indicated_by_event_postmetas() {
        ...
        $active_payment_method_in_backend = EE_Payment_Method_Manager::instance()
                                                                     ->activate_a_payment_method_of_type( 'Invoice' );
        $active_payment_method_in_backend->set_scope( array( EEM_Payment_Method::scope_admin ) );
        $active_payment_method_in_backend->save();
        $active_payment_method_in_frontend = EE_Payment_Method_Manager::instance()
                                                                      ->activate_a_payment_method_of_type( 'Bank' );
        ...
        $payment_methods_for_t = EEM_Payment_Method::instance()
                                                   ->get_all_for_transaction( $t, EEM_Payment_Method::scope_cart );
