...
/**
 *
 * EE_DMS_Payment_Methods_Pro_0_0_1
 *
 ...
 *
 */
class EE_DMS_Payment_Methods_Pro_1_0_0 extends EE_Data_Migration_Script_Base{

	public function __construct() {
		$this->_pretty_name = __("Data Migration to Payment Methods Pro 0.0.2", "event_espresso");
	...
	public function schema_changes_before_migration() {
		$this->_table_is_new_in_this_version('esp_payment_methods_pro_thing', '
			NEW_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
			NEW_name VARCHAR(10) NOT NULL,
			PRIMARY KEY  (NEW_ID)'
				);
		$this->_table_is_new_in_this_version('esp_payment_methods_pro_attendee_meta', '
...
// End of file EE_DMS_Payment_Methods_Pro_0_0_1.dms.php